...
public class ScreenshotTool : MonoBehaviour {
    ...
    public class ProjectSettings
    {
        ...
        [SerializeField]
        public enum ProjectNumber { Project1, Project2, Project3, Project4 };
        [SerializeField]
        public ProjectNumber projectNumber;
        [SerializeField]
        public enum WeekNumber { Week1, Week2, Week3, Week4, Week5 };
        [SerializeField]
    ...
    void Start()
    {
        ...
        if (cameras.playerCamera != null)
        {
            cameras.playerCamera.gameObject.SetActive(true);
        }
        else
        {
    ...
    void Update()
    {
        if (Input.GetKeyDown(toolSettings.playerCameraKey))
        {
            if (cameras.playerCamera != null)
            {
                Debug.Log("Viewing Camera: Player");
                cameras.DisableAllCameras();
                cameras.playerCamera.gameObject.SetActive(true);

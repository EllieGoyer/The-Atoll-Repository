...
public class ScreenshotGUI : Editor
{
    ...
    private SerializedProperty cameras_playerCamera_Property;
    ...
    void OnEnable()
    {
        ...
        cameras_playerCamera_Property = mySO.FindProperty("cameras.playerCamera");
    ...
    public override void OnInspectorGUI()
    {
        ...
        content = new GUIContent("Player Camera", "The camera that is used during any given section of the game. In most cases, the playerController camera.");
        EditorGUILayout.PropertyField(cameras_playerCamera_Property, content);
        GUILayout.Space(5);
